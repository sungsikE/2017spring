...
public class AddController{
	...
	public String edit(@PathVariable("sabun") int sabun,Model model) throws Exception {
		model.addAttribute("bean", guestService.detail(sabun));
		return "/guest/edit";
	}
	
	@RequestMapping(value="/guest/{sabun}/delete",method=RequestMethod.GET)
	public String delete(@PathVariable("sabun") int sabun,Model model) throws Exception {
